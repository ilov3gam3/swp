...
<script>
    ...
    dateInput.addEventListener("change", function (event) {
        ...
        for (let i = 0; i < filteredList.length; i++) {
            buttons += "<button type='button' onclick=\"changeTime('" + filteredList[i].id + "', '" + filteredList[i].start + "', '" + filteredList[i].end + "')\" class='btn btn-block col-6'>" + getTimeString(filteredList[i].start) + " - " + getTimeString(filteredList[i].end) + "</button>";
        }
        if (buttons === ""){
